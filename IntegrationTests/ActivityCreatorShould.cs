...
namespace IntegrationTests
{
    ...
    {
        // this test routinely fails
        //      because the ExcelReaderShould somehow didn't dispose the process properly?
        // running it manually will succeed every time.
        [Fact]
        public void Test1()
        {
            // Arrange
            var inputPath = "../../../../Files/Nikolai-Arbejdsopgave_2.xlsx";
            var outputPath = "../../../../Files/Activities.xlsx";
            var sut = new Runner(new ExcelReader(inputPath), new ExcelWriter(outputPath));
